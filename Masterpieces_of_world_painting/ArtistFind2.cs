...
{
    public partial class ArtistFind2 : Form
    {
        public ArtistFind2()
        {
            InitializeComponent();
        ...
        private void ArtistFind_Load(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text.ToString() == ""){
                if (comboBox2.Text.ToString() == "")
                {
                    sql = @"SELECT a.Name_artist, d.Name_direction, a.Date_of_birth, a.Date_of_death, c.Name_country
                        ...
                        WHERE Name_artist LIKE '" + mynum + "%'"; //+mynum;
                }
                else
                {
                    sql = @"SELECT a.Name_artist, d.Name_direction, a.Date_of_birth, a.Date_of_death, c.Name_country
                        ...
                        ON a.Id_direction = d.Id_direction
                        JOIN dbo.Countries AS c ON c.Id_country = a.Id_country
                        WHERE Name_artist LIKE '" + mynum + "%' AND a.Id_direction = (SELECT Id_direction FROM dbo.Directions WHERE Name_direction = '" + comboBox2.Text + "')"; //+mynum;
                }
            }
            else{
                if (comboBox2.Text.ToString() == "")
                {
                    sql = @"SELECT a.Name_artist, d.Name_direction, a.Date_of_birth, a.Date_of_death, c.Name_country
                        ...
                        ON a.Id_direction = d.Id_direction
                        JOIN dbo.Countries AS c ON c.Id_country = a.Id_country
                        WHERE Name_artist LIKE '" + mynum + "%' AND a.Id_country = (SELECT Id_country FROM dbo.Countries WHERE Name_country = '" + comboBox1.Text + "')"; //+mynum;
                }
                else
                {
                    sql = @"SELECT a.Name_artist, d.Name_direction, a.Date_of_birth, a.Date_of_death, c.Name_country
                        ...
                        ON a.Id_direction = d.Id_direction
                        JOIN dbo.Countries AS c ON c.Id_country = a.Id_country
                        WHERE Name_artist LIKE '" + mynum + "%' AND a.Id_direction = (SELECT Id_direction FROM dbo.Directions WHERE Name_direction = '" + comboBox2.Text + "') AND a.Id_country = (SELECT Id_country FROM dbo.Countries WHERE Name_country = '" + comboBox1.Text + "')"; //+mynum;
                }
            }
