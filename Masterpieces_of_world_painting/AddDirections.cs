...
{
    public partial class AddDirections : Form
    {
        ...
        private void AddDirections_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "masterpieces_of_world_paintingDataSet.vDirections". При необходимости она может быть перемещена или удалена.
            this.vDirectionsTableAdapter.Fill(this.masterpieces_of_world_paintingDataSet.vDirections);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            myCon2.Open();
            SqlCommand command2 = new SqlCommand("INSERT INTO dbo.Directions(Name_direction, Id_country, Time_of_appearance) VALUES ('" + textBox2.Text + "', (SELECT Id_country FROM dbo.Countries WHERE Name_country = '" + comboBox1.Text + "'), " + dateTimePicker1.Value.ToShortDateString() + ")",
                myCon2);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            myCon3.Open();
            SqlCommand command3 = new SqlCommand("DELETE FROM dbo.Directions WHERE Id_direction = '" + textBox1.Text + "'",
                myCon3);
