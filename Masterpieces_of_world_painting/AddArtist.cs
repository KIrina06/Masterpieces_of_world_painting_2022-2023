...
namespace Masterpieces_of_world_painting
{
    public partial class AddArtist : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "masterpieces_of_world_paintingDataSet.vArtists". При необходимости она может быть перемещена или удалена.
            this.vArtistsTableAdapter.Fill(this.masterpieces_of_world_paintingDataSet.vArtists);
        ...
        {
            Form findArtist = new ArtistFind();
            findArtist.Show();
            this.Hide();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            myCon2.Open();
            SqlCommand command2 = new SqlCommand("INSERT INTO dbo.Artists (Name_artist, Date_of_birth, Date_of_death, Id_direction, Id_country) VALUES ('" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "', (SELECT Id_direction FROM dbo.Directions WHERE Name_direction = '" + comboBox2.Text + "'), (SELECT Id_country FROM dbo.Countries WHERE Name_country = '" + comboBox1.Text + "'))",
                myCon2);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            myCon3.Open();
            SqlCommand command3 = new SqlCommand("DELETE FROM dbo.Artists WHERE Id_artist = '" + textBox1.Text + "'",
                myCon3);
