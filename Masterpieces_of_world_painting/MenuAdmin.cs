...
namespace Masterpieces_of_world_painting
{
    public partial class MenuAdmin : Form
    {
        ...
        {
            Form InformPaintForm = new PaintInfo();
        ...
        {
            Form InfoExposForm = new ExpositionInfo();
            InfoExposForm.Show();
            this.Hide();
        }
        ...
        {
            Form addPaintings = new AddPainting();
            addPaintings.Show();
            this.Hide();
        }
        ...
        {
            Form addDirections = new AddDirections();
            addDirections.Show();
            this.Hide();
        }
        ...
        {
            Form addCultInstitutions = new AddCultInst();
            addCultInstitutions.Show();
            this.Hide();
        }

        private void label9_Click(object sender, EventArgs e)
        {
            Form addExpositions = new AddExpos();
            addExpositions.Show();
            this.Hide();
        }
    }
